        ...
        <Row>
            <Col className="mb-6 d-flex">
                <Form.Control
                    ...
                    value={props.value}
                />
                <Button variant="outline-danger" size="sm" className="mx-2" id={props.id} onClick={props.delete}><i className="fa fa-archive" aria-hidden="true" /></Button>
            </Col>
        </Row>
    )
}
            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <p className="mt-2 mb-6">
                        Vous pouvez ajouter des materiels que vous pensez qu'il utilise de l'énérgie.
                    </p>
                    <Row>
                    ...
                    <Row>
                        <Col className="mb-6 d-flex">
                            ...
                            />
                            <Button variant="success" className="mx-2" onClick={addInput}>Ajouter</Button>
                        </Col>
                    </Row>
                </Card.Body>
            </Card>
